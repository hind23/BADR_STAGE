...
export const Accueil = () => {
    ...
    return (
        <>
            {/* Exemple de Navbar, à remplacer par ta propre implémentation */}
            <nav className="bg-[#085526] text-white p-4">
                <h1 className="text-2xl font-bold">Navbar</h1>
            </nav>

            {/* Section avec l'image comme fond */}
            <div className="relative h-[80vh] w-full">
                <img src={expert} alt="Expert en finance" className="absolute w-full h-full object-cover" />
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white bg-black bg-opacity-50">
                    <h2 className="text-4xl font-bold mb-4">Financement islamique</h2>
            ...
            src={logo} 
            alt={"logo"} 
            className="w-1/6 h-auto object-cover absolute top-10 right-4 z-20" // Adjust width and positioning
          />
            </div>
            ...
            <div className="font-roboto  h-fit" style={{
                ...
                <div className="flex items-center justify-center space-x-8 mt-4 mr-10 ml-10">
                    ...
                    {/* Image */}
                    <img src={finance} alt="Finance islamique" className="w-1/2 max-w-full rounded-lg mr-10" />
                </div>
            </div>
        </>
    );
